...
DEFINE_TEST(test_option_owner)
{
	...
	failure("Error invoking %s c", testprog);
	assertEqualInt(0,
	    systemf("%s cf archive2 --owner=65123 --gid=65123 --format=ustar "
	...
	failure("Error invoking %s c", testprog);
	assertEqualInt(0,
	    systemf("%s cf archive3 --uid=0 --owner=foofoofoo --gid=0 "
	...
	failure("Error invoking %s c", testprog);
	assertEqualInt(0,
	    systemf("%s cf archive4 --owner=foofoofoo:65123 --gid=0 "
